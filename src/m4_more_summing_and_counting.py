...
def run_test_count_cosines_from():
    ...
    expected = 2
    answer = count_cosines_from(6, 9, 0.39)
    print('Test 1 expected:', expected)
    print('       actual:  ', answer)
...
def run_test_sum_unit_fractions_from():
    ...
    expected = 1.717857  # This is APPROXIMATELY the correct answer.
    answer = sum_unit_fractions_from(2, 8)
    print('Test 1 expected:', expected, '(approximately)')
    print('       actual:  ', answer)

    expected = 0.783333  # This is APPROXIMATELY the correct answer.
